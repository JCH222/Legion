namespace Legion.Test
{
    ...
    public class IterativeSolver
    {
        ...
        [Test]
        public void TestSolveGaussSeidel1()
		{
            // Example : speed reduction impulse
            ...
            SolvingStatus status = Mathematics.LinearSystem.IterativeSolver.SolveWithGaussSeidel(1, in fCoefficients, 
                in fResults, ref fVariables, ref fErrors, ref fInverseDiagonalCoefficients, convergenceCondition);
            Assert.AreEqual(SolvingStatus.VALID, status);
            Assert.AreEqual(0.0f, fErrors[0]);
            Assert.AreEqual(-20.0f, fVariables[0]);
            ...
            status = Mathematics.LinearSystem.IterativeSolver.SolveWithGaussSeidel(1, in fCoefficients, in fResults,
                ref fVariables, ref fErrors, ref fInverseDiagonalCoefficients, convergenceCondition);
            Assert.AreEqual(SolvingStatus.VALID, status);
            Assert.AreEqual(0.0f, fErrors[0]);
            Assert.AreEqual(-20.0f, fVariables[0]);
        ...
        [Test]
        public void TestSolveGaussSeidel2()
		{
            // Example : speed reduction impulses
            //                          G
            // Impulse1 -> |____________x_______| <- Impulse2
            ...
            SolvingStatus status = Mathematics.LinearSystem.IterativeSolver.SolveWithGaussSeidel(2, in fCoefficients, 
                in fResults, ref fVariables, ref fResiduals, ref fInverseDiagonalCoefficients, convergenceCondition);
            Assert.AreEqual(SolvingStatus.VALID, status);
            Assert.AreEqual(-4.19616699E-05f, fResiduals[0]);
            Assert.AreEqual(9.99995708f, fVariables[0]);
            Assert.AreEqual(-3.05175781E-05f, fResiduals[1]);
            ...
            status = Mathematics.LinearSystem.IterativeSolver.SolveWithGaussSeidel(2, in fCoefficients, 
                in fResults, ref fVariables, ref fResiduals, ref fInverseDiagonalCoefficients, convergenceCondition);
            Assert.AreEqual(SolvingStatus.VALID, status);
            Assert.AreEqual(0.0f, fResiduals[0]);
            Assert.AreEqual(7.11111116f, fVariables[0]);
            Assert.AreEqual(-9.53674316E-07f, fResiduals[1]);
            Assert.AreEqual(-3.22222257f, fVariables[1]);
            ...
            status = Mathematics.LinearSystem.IterativeSolver.SolveWithGaussSeidel(2, in fCoefficients, in fResults,
              ref fVariables, ref fResiduals, ref fInverseDiagonalCoefficients, convergenceCondition);
            Assert.AreEqual(SolvingStatus.INCOMPATIBLE, status);
        }
    }
}
